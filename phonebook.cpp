...
class PhoneBook {
   ...
   */
   ...
   void Insert(string name, string number) {
      ...
      cout<<"\n <"<<name<<", "<<number<<">"<<" Is in your directory"<<endl;
   }
...
int main()
{
   ...
   while (1)
   {
      cout<<"1.Enter number 1 to insert an element into the phone book"<<endl;
      cout<<"2.Enter number 2 to retrive the number using the name"<<endl;
      cout<<"3. Enter number 3 to Exit"<<endl;
